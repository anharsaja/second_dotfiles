...
(() => {
    const e = function() {
        const e = {}, t = [ [ "document.createElement", "make_rand_div" ], [ "Object.prototype.pgmp", "invokeInterstitial" ] ], r = new Map([ [ "pcbeta.com", 0 ], [ "yfsp.tv", 1 ], [ "aiyifan.tv", 1 ], [ "iyf.tv", 1 ] ]), n = new Map([]), o = new Map([]);
        function c(e = "", t = "") {
        ...
        function s(e, t = "") {
            ...
            const f = l.join("\t"), p = !0 !== e.matchAll && r.testPattern(e, f);
            return ("all" === t || "match" === t && p || "nomatch" === t && !p) && r.uboLog(f.replace(/\t/g, "\n")), 
            p;
        }
        function a() {
        ...
        if (0 !== n.size) {
            ...
            for (let t = 0; t < e; t++) for (let r = e; r > t; r--) {
                ...
                if (void 0 !== o) {
                    "number" == typeof o && (o = [ o ]);
                    for (const e of o) g.includes(e) || p.add(e);
                }
            }
            n.clear();
        }
