...
(() => {
    const e = function() {
        const e = {}, t = [ [ "float_right > div" ], [ "adblock_tip" ], [ "/\\.height\\(\\) == 0|adsbygoogle/" ], [ "myModal" ], [ "loadErrorTip" ], [ "ins.adsbygoogle" ], [ "_0x" ], [ "adblock" ], [ "发现严重BUG" ], [ "checker" ], [ "/tpc.?[A-Z0-9].?tml/" ], [ "/home/?adblock=" ], [ "ad_num_show" ], [ "adsbygoogle" ], [ "ad_ids" ], [ "checkSiteNormalLoad" ], [ "/ad block stop|warm_msg/" ], [ 'getCookie("' ], [ "location.href", "3000" ], [ "/document\\.getElementById[\\s\\S]*?\\.style\\.display\\.indexOf/" ] ], o = new Map([ [ "18comic.vip", 0 ], [ "itdog.cn", 1 ], [ "xbeibeix.com", 2 ], [ "520cc.cc", [ 3, 18 ] ], [ "colamanga.com", 4 ], [ "cocomanga.com", [ 4, 15 ] ], [ "ekamus.info", 5 ], [ "logi.im", 5 ], [ "moeci.com", 6 ], [ "tingfm.com", 7 ], [ "233tw.com", 8 ], [ "ruanyifeng.com", 9 ], [ "t66y.com", 10 ], [ "tsubasa.im", 11 ], [ "league-funny.com", 12 ], [ "haoweichi.com", 13 ], [ "zhenbuka.com", 14 ], [ "ohmanhua.com", 15 ], [ "onemanhua.com", 15 ], [ "5278.cc", 16 ], [ "hboav.com", 16 ], [ "axutongxue.net", 17 ], [ "nfmovies.com", 19 ] ]), n = new Map([]), r = new Map([]);
        function c(t = "", o = "") {
            ...
            }(), r = n.makeLogPrefix("prevent-setTimeout", t, o), c = "!" === t.charAt(0);
            c && (t = t.slice(1)), "" === o && (o = void 0);
            let i = !1;
            void 0 !== o && (i = "!" === o.charAt(0), i && (o = o.slice(1)), o = parseInt(o, 10));
            const s = n.patternToRegex(t);
            self.setTimeout = new Proxy(self.setTimeout, {
                apply: function(e, a, l) {
                    ...
                    let f;
                    return "" !== t && (f = s.test(g) !== c), !1 !== f && void 0 !== o && (f = (p === o || isNaN(p) && isNaN(o)) !== i), 
