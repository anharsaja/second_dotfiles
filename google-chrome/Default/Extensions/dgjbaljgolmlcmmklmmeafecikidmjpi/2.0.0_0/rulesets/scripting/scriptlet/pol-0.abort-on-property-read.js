...
(() => {
    const e = function() {
        const e = {}, t = [ [ "WP.inline" ], [ "__headpayload" ], [ "Object.prototype.bodyCode" ], [ "launchOpenWindow" ], [ "o6c6e" ], [ "uabpd3" ], [ "checkAds" ], [ "zfgformats" ], [ "mdpDeBlocker" ], [ "HateAdBlock" ], [ "adBlockDetected" ], [ "abask" ] ], r = new Map([ [ "wp.pl", 0 ], [ "www.wp.pl", 1 ], [ "sportowefakty.wp.pl", 2 ], [ "anyfiles.pl", 3 ], [ "animezone.pl", 4 ], [ "pcworld.pl", 5 ], [ "astroweb.pl", 6 ], [ "exdb.net", [ 7, 8 ] ], [ "epidemia-koronawirus.pl", 8 ], [ "trojmiasto.pl", [ 9, 10 ] ], [ "kurnik.pl", 11 ] ]), o = new Map([]), n = new Map([ [ "pilot.wp.pl", [ 0 ] ], [ "poczta.wp.pl", [ 0 ] ], [ "sportowefakty.wp.pl", [ 0 ] ] ]);
        function s(e = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const t = c(), r = t.makeLogPrefix("abort-on-property-read", e), o = function() {
                ...
                if (-1 === r) {
                    ...
                    return void (r && r.get === n || Object.defineProperty(e, t, {
                        get: n,
                        set: function() {}
                    }));
                }
                const o = t.slice(0, r);
                let c = e[o];
                if (t = t.slice(r + 1), c) return void s(c, t);
                const i = Object.getOwnPropertyDescriptor(e, o);
                i && void 0 !== i.set || Object.defineProperty(e, o, {
                    get: function() {
                        return c;
                    },
                    set: function(e) {
                        c = e, e instanceof Object && s(e, t);
                    }
                });
            }, i = window;
            s(i, e);
    ...
    if ("object" != typeof wrappedJSObject) return e();
    {
        ...
        o && (r && r.remove(), t.URL.revokeObjectURL(o)), delete t.uBOL_abortOnPropertyRead;
    }
})();