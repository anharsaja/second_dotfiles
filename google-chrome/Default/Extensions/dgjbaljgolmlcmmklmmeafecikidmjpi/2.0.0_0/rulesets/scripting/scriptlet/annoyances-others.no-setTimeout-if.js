...
(() => {
    const e = function() {
        const e = {}, t = [ [ "_waitingAuth0Counter" ], [ "window.loginStateChange.subscribe" ], [ "custom-modal-create-account-link" ], [ "loginModal" ] ], o = new Map([ [ "clarin.com", 0 ], [ "tradingview.com", 1 ], [ "tekinvestor.no", 2 ], [ "analyticsvidhya.com", 3 ] ]), n = new Map([]), r = new Map([]);
        function s(t = "", o = "") {
