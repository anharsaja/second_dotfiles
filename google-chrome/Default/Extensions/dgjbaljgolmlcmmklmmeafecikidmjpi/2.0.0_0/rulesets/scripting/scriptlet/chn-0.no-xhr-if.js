...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/api/ads" ], [ "adsbygoogle" ] ], r = new Map([ [ "noy1.top", 0 ], [ "pansearch.me", 1 ] ]), n = new Map([]), s = new Map([]);
        function o(t = "", r = "") {
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, a, ...u) {
                    ...
                    return "" === t && "" === r ? (n.uboLog(s, `Called: ${n.JSON_stringify(h, null, 2)}`), 
                    super.open(e, a, ...u)) : (i(c, h) && o.set(this, h), h.headers = Object.assign({}, l), 
                    super.open(e, a, ...u));
                }
                send(...t) {
                    const i = o.get(this);
