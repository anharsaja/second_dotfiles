...
!function() {
    const e = {}, t = [ [ "tracker_visitor_id" ], [ "/captcha_key|last_file|_scrs_/" ] ], o = new Map([ [ "tamasha.com", 0 ], [ "uploadboy.com", 1 ] ]), n = new Map([]), r = new Map([]);
    function s(t = "") {
        ...
        const o = function() {
            ...
            document.cookie.split(";").forEach((e => {
                ...
                const r = o + "=", s = "; domain=" + document.location.hostname, i = "; domain=." + document.location.hostname;
                let c, a;
                const l = document.domain;
                l && (l !== document.location.hostname && (c = "; domain=." + l), l.startsWith("www.") && (a = "; domain=" + l.replace("www", "")));
                const d = "; path=/", g = "; Max-Age=-1000; expires=Thu, 01 Jan 1970 00:00:00 GMT";
                document.cookie = r + g, document.cookie = r + s + g, document.cookie = r + i + g, 
                document.cookie = r + d + g, document.cookie = r + s + d + g, document.cookie = r + i + d + g, 
                void 0 !== c && (document.cookie = r + c + d + g), void 0 !== a && (document.cookie = r + a + d + g);
            }));
        };
        if (i(), window.addEventListener("beforeunload", i), "string" != typeof r.when) return;
        const c = [ "scroll", "keydown" ], a = r.when.split(/\s/);
        for (const e of a) !1 !== c.includes(e) && document.addEventListener(e, (() => {
            s(i);
        }), {
            passive: !0
        });
