...
!function() {
    const e = {}, t = [ [ "modal-open", "body" ], [ "bottom-l", "body", "stay" ], [ "bottom-s", "body", "stay" ], [ "modal-open", "body", "stay" ], [ "darken", "body" ], [ "blurry", "body > :not(.m-fbPopup)", "stay" ], [ "have-ad", "body" ] ], o = new Map([ [ "hetek.hu", 0 ], [ "magyarorszag.hu", [ 1, 2 ] ], [ "mandiner.hu", 3 ], [ "traffihunter.hu", 4 ], [ "vezess.hu", 5 ], [ "pcworld.hu", 6 ] ]), r = new Map([]), n = new Map([]);
    function s(e = "", t = "", o = "") {
        if ("string" != typeof e) return;
        if ("" === e) return;
        const r = a(), n = r.makeLogPrefix("remove-class", e, t, o), s = e.split(/\s*\|\s*/), i = s.map((e => `${t}.${CSS.escape(e)}`)).join(",");
