...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/www3\\.doubleclick\\.net|tagger\\.opecloud\\.com|fwmrm\\.net/" ], [ "tag.min.js" ], [ "fwmrm" ], [ "pagead2.googlesyndication.com" ], [ "js.sddan.com" ], [ "static.adsafeprotected.com/favicon.ico method:HEAD" ], [ "/^https:\\/\\/ads\\.stickyadstv\\.com\\/$/ method:HEAD" ] ], r = new Map([ [ "rmcbfmplay.com", 0 ], [ "france.tv", 2 ], [ "lameteoagricole.net", 3 ], [ "meteo-grenoble.com", 3 ], [ "signal-arnaques.com", 3 ], [ "techno-science.net", 3 ], [ "animationdigitalnetwork.fr", 3 ], [ "animedigitalnetwork.fr", 3 ], [ "malekal.com", 4 ], [ "tf1.fr", [ 5, 6 ] ], [ "tf1info.fr", [ 5, 6 ] ] ]), o = new Map([ [ "darkino", 1 ] ]), n = new Map([]);
        function s(t = "", r = "") {
            ...
            self.fetch = new Proxy(self.fetch, {
                apply: function(i, a, l) {
                    const f = l[0] instanceof self.Request ? l[0] : Object.assign({
                        url: l[0]
                    }, l[1]);
                    let p = !0;
                    try {
                    ...
                    let g = "";
                    if (void 0 === f.mode || "cors" === f.mode) try {
                        const e = new URL(f.url);
