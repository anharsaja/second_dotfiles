    ...
    const e = function() {
        ...
        function o(t = "", r = "") {
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, a, ...l) {
                    if (o.delete(this), void 0 !== u && a.startsWith(u)) return super.open(e, a, ...l);
                    const d = {
                        method: e,
                        url: a
                    };
                    return "" === t && "" === r ? (n.uboLog(s, `Called: ${n.JSON_stringify(d, null, 2)}`), 
                    super.open(e, a, ...l)) : (i(c, d) && o.set(this, d), d.headers = Object.assign({}, p), 
                    super.open(e, a, ...l));
                }
                send(...t) {
                    const i = o.get(this);
        ...
        if (0 !== r.size) {
            ...
            for (let t = 0; t < u; t++) e(c.slice(t).join("."));
            e("*"), r.clear();
        }
        if (0 !== n.size) {
            const e = u - 1;
            for (let t = 0; t < e; t++) for (let r = e; r > t; r--) {
                ...
                if (void 0 !== s) {
                    "number" == typeof s && (s = [ s ]);
                    for (const e of s) l.includes(e) || p.add(e);
                }
            }
            n.clear();
        }
