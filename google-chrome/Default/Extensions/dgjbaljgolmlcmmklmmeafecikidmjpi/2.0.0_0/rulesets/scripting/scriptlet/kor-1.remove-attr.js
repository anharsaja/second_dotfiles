...
(() => {
    const e = function() {
        const e = {}, t = [ [ "placeholder", '#webzineHeadmenuF1 input[placeholder][autocomplete="off"]' ], [ "placeholder", "input#searchMainKeyword" ], [ "placeholder", "input#searchKeyword" ], [ "placeholder", "input.search_input", "asap stay" ] ], r = new Map([ [ "inven.co.kr", 0 ], [ "kyobobook.co.kr", [ 1, 2 ] ], [ "pping.kr", 3 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "", t = "", r = "") {
