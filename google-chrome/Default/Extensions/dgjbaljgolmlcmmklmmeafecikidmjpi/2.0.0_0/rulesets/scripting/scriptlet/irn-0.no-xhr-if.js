...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/fa/generate/userid" ], [ "cpc" ], [ "candidatelogapi method:POST" ], [ "PlayReports" ] ], r = new Map([ [ "asriran.com", 0 ], [ "digikala.com", 1 ], [ "jobvision.ir", 2 ], [ "play.namava.ir", 3 ] ]), n = new Map([]), s = new Map([]);
        function o(t = "", r = "") {
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, a, ...u) {
                    ...
                    super.open(e, a, ...u)) : (i(c, d) && o.set(this, d), d.headers = Object.assign({}, l), 
                    super.open(e, a, ...u));
                }
                send(...t) {
                    const i = o.get(this);
