...
(() => {
    const e = function() {
        const e = {}, t = [ [ "Math.floor", "offsetHeight" ], [ "onload", "noBackPlease" ], [ "setTimeout", "admc" ] ], r = new Map([ [ "competentedigitale.ro", 0 ], [ "cool-etv.net", 1 ], [ "posturi.live", 2 ] ]), n = new Map([]), o = new Map([]);
        function c(...t) {
            !function(e) {
