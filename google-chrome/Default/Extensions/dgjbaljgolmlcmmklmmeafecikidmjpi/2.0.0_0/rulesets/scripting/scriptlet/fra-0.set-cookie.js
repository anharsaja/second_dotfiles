...
!function() {
    const e = {}, t = [ [ "warnadb", "1" ], [ "p_view", "true" ], [ "q_pop_noel", "true" ], [ "mpf_popup_desktop", "true" ] ], o = new Map([ [ "pianoweb.fr", 0 ], [ "jeune-gay.fr", 1 ], [ "lexpress.fr", 2 ], [ "monpetitforfait.com", 3 ] ]), r = new Map([]), n = new Map([]);
    function s(t = "", o = "", r = "") {
        if ("" === t) return;
        const n = function() {
