...
(() => {
    const e = function() {
        const e = {}, t = [ [ "ntmt_retest_btn_countdown_do", "1000" ] ], r = new Map([ [ "rychlost.cz", 0 ], [ "rychlost.sk", 0 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "", n = "") {
            ...
            c = !1 === isNaN(c) && isFinite(c) ? Math.min(Math.max(c, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, t, r) {
                    const [n, a] = r;
                    return -1 !== s && a !== s || !o.test(n.toString()) || (r[1] = a * c), e.apply(t, r);
                }
            });
        }
        const c = [];
        ...
        if (0 !== n.size) {
            ...
            for (let t = 0; t < e; t++) for (let r = e; r > t; r--) {
                ...
                if (void 0 !== o) {
                    "number" == typeof o && (o = [ o ]);
                    for (const e of o) l.includes(e) || i.add(e);
                }
            }
            n.clear();
        }
