...
(() => {
    const e = function() {
        const e = {}, t = [ [ "userConsentProcessEnded", "*", "0.001" ], [ '/userConsentProcessEnded|\\[0\\]\\+"With"/', "*", "0.001" ], [ "#regarder", "7000", "0.02" ] ], r = new Map([ [ "magicmaman.com", 0 ], [ "cosmopolitan.fr", 1 ], [ "zoneseries.stream", 2 ] ]), o = new Map([]), n = new Map([]);
        function s(t = "", r = "", o = "") {
