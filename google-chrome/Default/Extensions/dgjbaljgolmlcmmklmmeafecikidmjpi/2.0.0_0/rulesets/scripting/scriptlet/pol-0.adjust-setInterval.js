...
(() => {
    const e = function() {
        const e = {}, t = [ [], [ "redirectId" ] ], r = new Map([ [ "filmowakraina.tv", 0 ], [ "auto-motor-i-sport.pl", 1 ], [ "menshealth.pl", 1 ], [ "motocykl-online.pl", 1 ], [ "runners-world.pl", 1 ], [ "womenshealth.pl", 1 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "", n = "") {
