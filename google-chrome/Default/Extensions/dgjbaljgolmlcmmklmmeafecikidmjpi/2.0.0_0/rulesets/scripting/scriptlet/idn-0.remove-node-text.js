...
!function() {
    const e = {}, t = [ [ "script", "adblock" ], [ "script", "hargamenu" ], [ "script", "replaceState", "condition", "shope.ee" ], [ "script", "showModal" ] ], o = new Map([ [ "almaftuchin.com", 0 ], [ "wisatalova.com", 1 ], [ "gramedia.com", 2 ], [ "carisinyal.com", 3 ] ]), r = new Map([]), n = new Map([]);
    function s(e, t, ...o) {
        !function(e = "", t = "", o = "") {
            const r = i(), n = r.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = r.patternToRegex(e, "i", !0), c = r.patternToRegex(t, "gms"), a = r.getExtraArgs(Array.from(arguments), 3), l = r.patternToRegex(a.condition || "", "ms"), g = (e = !0) => {
                e && u(f.takeRecords()), f.disconnect(), r.logLevel > 1 && r.uboLog(n, "Quitting");
            };
            let d = a.sedCount || 0;
            const p = e => {
