...
(() => {
    const e = function() {
        const e = {}, t = [ [ "dfpConfig", "loadAds" ], [ "adblockDetector" ], [ "AdsReloadConfig" ], [ "EventTarget.prototype.addEventListener", "window.TextDecoder" ] ], r = new Map([ [ "gamer.no", 0 ], [ "tu.no", 0 ], [ "tv2.no", 1 ], [ "bold.dk", 3 ] ]), n = new Map([ [ "gamereactor", 2 ] ]), o = new Map([]);
        function c(...t) {
            !function(e) {
                ...
                !function(t = "", r = "", n = "") {
                    ...
                    if ("" === t) return;
                    const o = s(), c = o.makeLogPrefix("abort-current-script", t, r, n), i = o.patternToRegex(r), a = o.patternToRegex(n), l = o.getExtraArgs(Array.from(arguments), 3), f = document.currentScript, g = t.split(".");
                    let u, p, d = window;
                    for (;u = g.shift(), 0 !== g.length && u in d != 0; ) if (d = d[u], d instanceof Object == 0) return;
                    let h = Object.getOwnPropertyDescriptor(d, u);
                    h instanceof Object != 0 && h.get instanceof Function != 0 || (p = d[u], h = void 0), 
                    function(t) {
                    ...
                    try {
                        Object.defineProperty(d, u, {
                            get: function() {
                                return v(), h instanceof Object ? h.get.call(d) : p;
                            },
                            set: function(e) {
                                v(), h instanceof Object ? h.set.call(d, e) : p = e;
                            }
                        });
                    } catch (e) {
                        o.uboErr(c, `Error: ${e}`);
