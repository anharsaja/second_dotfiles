    ...
    function s(t = "", o = "", r = "") {
        ...
        if ("" !== o) {
            const e = o.split(",").map((e => {
                ...
                const a = s.indexOf("="), l = -1 !== a ? s.slice(0, a).trim() : s, u = -1 !== a ? s.slice(a + 1).trim() : "";
                return i.re = new RegExp(`^${this.escapeRegexChars(l)}=${this.escapeRegexChars(u)}`), 
                i;
        ...
        const p = () => {
            ...
            const t = Date.now();
            if (t >= u) return n.uboLog(s, "Timed out"), p();
            e && g();
        ...
        const m = () => {
            ...
            n.uboLog(s, `Clicked ${e}`), t.click(), d += a, f();
        };
        !function(e) {
