...
!function() {
    const e = {}, t = [ [], [ "12" ] ], r = new Map([ [ "1movietv.com", 0 ], [ "legendas.dev", 0 ], [ "telesintese.com.br", 0 ], [ "novsport.com", 0 ], [ "deckbandit.com", 0 ], [ "getcopy.link", 0 ], [ "ricettafitness.com", 0 ], [ "yts-subs.dev", 0 ], [ "edoujin.net", 0 ], [ "bitcotasks.com", 0 ], [ "blackmod.net", 0 ], [ "click.allkeyshop.com", 0 ], [ "cl1ca.com", 1 ], [ "4br.me", 1 ], [ "fir3.net", 1 ] ]), o = new Map([ [ "seulink", 1 ], [ "encurtalink", 1 ] ]), n = new Map([]);
    function s(e = "") {
        ...
        !function(e, t) {
            ...
            (() => {
                const o = document.querySelector('meta[http-equiv="refresh" i][content]');
                if (null === o) return;
                t.uboLog(r, `Prevented "${o.textContent}"`);
                const n = "" === e ? o.getAttribute("content") : e, s = 1e3 * Math.max(parseFloat(n) || 0, 0);
                setTimeout((() => {
                    window.stop();
                }), s);
            })();
