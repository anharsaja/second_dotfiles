...
(() => {
    const e = function() {
        const e = {}, t = [ [ "adsBlocked" ], [ "ABDetector" ], [ "Object.prototype.autoRecov" ], [ "gothamBatAdblock" ], [ "mdpDeBlocker" ], [ "onload" ], [ "adsurgeNode" ], [ "zoneSett" ], [ "__yget_ad_list" ], [ "_adb" ] ], r = new Map([ [ "benjaminellisbernard.fr", 0 ], [ "ebookdz.com", 1 ], [ "radio.fr", 2 ], [ "vostfr.stream", 3 ], [ "9docu.org", 3 ], [ "bleachmx.fr", 4 ], [ "iphonetweak.fr", 5 ], [ "iphonesoft.fr", 5 ], [ "filmstreamy.com", 6 ], [ "11anim.com", 7 ], [ "basketusa.com", 8 ], [ "lindependant.fr", 9 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "") {
        ...
        if (0 !== o.size) {
            ...
            for (let t = 0; t < e; t++) for (let r = e; r > t; r--) {
                ...
                if (void 0 !== n) {
                    "number" == typeof n && (n = [ n ]);
                    for (const e of n) f.includes(e) || l.add(e);
                }
            }
            o.clear();
        }
