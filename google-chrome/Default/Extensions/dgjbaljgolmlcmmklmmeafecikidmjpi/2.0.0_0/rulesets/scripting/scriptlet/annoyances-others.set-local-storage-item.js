...
!function() {
    const e = {}, t = [ [ "gatedSignupTimerCounter", "$remove$" ], [ "history", "$remove$" ], [ "wp_dark_mode_active", "1" ], [ "perm_cnn_regwall_v1", "$remove$" ], [ "REG_WALL_METER", "$remove$" ], [ "ArcP", "$remove$" ], [ "kiosq_article_reset", "$remove$" ], [ "kiosq_article_url_ack", "$remove$" ], [ "newYeradlariWebsiteHidden", "true" ], [ "mode-quills", "$remove$" ], [ "LMT_freeUserUsageBlock", "$remove$" ], [ "onboardingData", "$remove$" ] ], r = new Map([ [ "zippia.com", 0 ], [ "bloomberg.com", 1 ], [ "dailynewshungary.com", 2 ], [ "cnn.com", [ 3, 4 ] ], [ "reuters.com", 5 ], [ "theweek.com", [ 6, 7 ] ], [ "nisanyansozluk.com", 8 ], [ "quillbot.com", 9 ], [ "deepl.com", [ 10, 11 ] ] ]), o = new Map([]), n = new Map([]);
    function s(t = "", r = "") {
