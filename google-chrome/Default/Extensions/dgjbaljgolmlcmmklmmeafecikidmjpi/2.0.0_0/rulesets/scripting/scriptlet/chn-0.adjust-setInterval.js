...
(() => {
    const e = function() {
        const e = {}, t = [ [ ".s--", "", "0.02" ], [ "timerAdCountdown", "", "0.02" ], [ "timerAdCountdownCount", "", "0.02" ] ], r = new Map([ [ "tangdoucdn.com", 0 ], [ "bde4.com", 1 ], [ "nfmovies.com", 2 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "", n = "") {
            ...
            let c = parseFloat(n);
            c = !1 === isNaN(c) && isFinite(c) ? Math.min(Math.max(c, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, t, r) {
                    const [n, i] = r;
                    return -1 !== s && i !== s || !o.test(n.toString()) || (r[1] = i * c), e.apply(t, r);
                }
            });
        }
        const c = [];
