...
(() => {
    const e = function() {
        const e = {}, t = [ [ "DOMContentLoaded", "js-revoke-cookie-manager" ], [ "load", "consentDialog" ], [ "load", "function(){if(s.readyState==XMLHttpRequest.DONE" ], [ "scroll", "innerHeight" ] ], n = new Map([ [ "ubuntu.com", 0 ], [ "finna.fi", 1 ], [ "sss.fi", 2 ], [ "akaanseutu.fi", 3 ], [ "alueviesti.fi", 3 ], [ "kiuruvesilehti.fi", 3 ], [ "lempaala.ideapark.fi", 3 ], [ "lvs.fi", 3 ], [ "olutposti.fi", 3 ], [ "orivedensanomat.fi", 3 ], [ "pirmediat.fi", 3 ], [ "radiosun.fi", 3 ], [ "shl.fi", 3 ], [ "urjalansanomat.fi", 3 ], [ "ylojarvenuutiset.fi", 3 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
            const r = i(), o = r.getExtraArgs(Array.from(arguments), 2), s = r.makeLogPrefix("prevent-addEventListener", t, n), a = r.patternToRegex(t, void 0, !0), c = r.patternToRegex(n), l = (function(t) {
                ...
                return (!i || void 0 === l || !1 !== (!!((u = e) && u.matches && u.matches(l)) || Array.from(document.querySelectorAll(l)).includes(u))) && i;
                var u;
            };
            !function(e, t) {
                const n = e => {
                ...
                (() => {
                    const e = {
                        apply: function(e, o, i) {
                            ...
                            if ("" === t && "" === n) r.uboLog(s, `Called: ${a}\n${c}\n${u(o)}`); else if (f(o, a, c)) return r.uboLog(s, `Prevented: ${a}\n${c}\n${u(o)}`);
