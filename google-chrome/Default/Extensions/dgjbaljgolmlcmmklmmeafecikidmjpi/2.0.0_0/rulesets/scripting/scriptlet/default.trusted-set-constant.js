...
(() => {
    const e = function() {
        const e = {}, t = [ [ "premium", "'1'" ], [ "premium", "1" ], [ "navigator.userAgent", '{"value": "Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.0 Mobile/15E148 Safari/604.1"}' ], [ "navigator.platform", '{"value": "iPhone"}' ], [ "navigator.userAgent", '{"value": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML\\, like Gecko) Chrome/119.0.0.0 Safari/537.36"}' ], [ "document.visibilityState", "visible" ] ], n = new Map([ [ "emturbovid.com", 0 ], [ "tuborstb.co", 1 ], [ "app.blubank.com", 2 ], [ "mobileweb.bankmellat.ir", [ 2, 3 ] ], [ "web.bale.ai", 4 ], [ "financemonk.net", 5 ] ]), r = new Map([ [ "dropgalaxy", 5 ] ]), o = new Map([]);
        function i(...e) {
            !function(e = !1, t = "", n = "") {
                if ("" === t) return;
                ...
                function c(t, n) {
                    ...
                    const f = function(t) {
                        ...
                        let c, a;
                        s instanceof r.Object && (e[t] = l, s.get instanceof Function && (c = s.get), s.set instanceof Function && (a = s.set));
                        try {
    ...
    if ("object" != typeof wrappedJSObject) return e();
    {
        ...
        r && (n && n.remove(), t.URL.revokeObjectURL(r)), delete t.uBOL_trustedSetConstant;
    }
})();