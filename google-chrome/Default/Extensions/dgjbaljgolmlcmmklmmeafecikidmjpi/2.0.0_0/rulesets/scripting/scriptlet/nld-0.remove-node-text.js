...
!function() {
    const e = {}, t = [ [ "script", "if(!document.getElementById" ] ], o = new Map([ [ "looopings.nl", 0 ] ]), n = new Map([]), r = new Map([]);
    function s(e, t, ...o) {
        !function(e = "", t = "", o = "") {
            const n = i(), r = n.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = n.patternToRegex(e, "i", !0), c = n.patternToRegex(t, "gms"), a = n.getExtraArgs(Array.from(arguments), 3), l = n.patternToRegex(a.condition || "", "ms"), g = (e = !0) => {
                e && u(p.takeRecords()), p.disconnect(), n.logLevel > 1 && n.uboLog(r, "Quitting");
            };
            let d = a.sedCount || 0;
            const f = e => {
    ...
    if (0 !== n.size) {
        ...
        for (let t = 0; t < e; t++) for (let o = e; o > t; o--) {
            ...
            if (void 0 !== r) {
                "number" == typeof r && (r = [ r ]);
                for (const e of r) g.includes(e) || l.add(e);
            }
        }
        n.clear();
    }
