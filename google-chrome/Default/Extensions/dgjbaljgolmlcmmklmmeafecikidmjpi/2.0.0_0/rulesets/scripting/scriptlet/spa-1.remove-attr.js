...
(() => {
    const e = function() {
        const e = {}, t = [ [ "href", "a[href]#clickfakeplayer" ], [ "href", 'li[onclick^="go_to_player"] > a[target="_blank"][href]' ], [ "href", 'a[href^="https://adalites.site/"]' ], [ "href", '.leaving-message center > a.btn[onclick^="window.open"][href*="/ads.html"]' ] ], r = new Map([ [ "pobreflix.vc", 0 ], [ "animesgratis.org", 0 ], [ "serieslatinoamerica.tv", 0 ], [ "pepeliculas.org", 0 ], [ "cinetux.to", 0 ], [ "gnula.club", 1 ], [ "pelisplushd.site", 2 ], [ "compartiendofull.net", 3 ] ]), o = new Map([ [ "assistirfilmeshdgratis", 0 ] ]), n = new Map([]);
        function s(e = "", t = "", r = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const o = i(), n = o.makeLogPrefix("remove-attr", e, t, r), s = e.split(/\s*\|\s*/), c = s.map((e => `${t}[${CSS.escape(e)}]`)).join(",");
            let a;
