...
(() => {
    const e = function() {
        const e = {}, t = [ [], [ "#timer" ], [ ".numcard" ], [ ".time" ], [ ".track-download__timer" ], [ "closeWait", "1800" ], [ "countdown" ], [ "disabled" ], [ "js-game-loader-block", "1000", "0.0001" ], [ "ks_counter" ], [ "p" ], [ "timer" ] ], r = new Map([ [ "595.ucoz.net", 0 ], [ "5wip-file.ru", 0 ], [ "file-mods.ru", 0 ], [ "freesoft.ru", 0 ], [ "infourok.ru", 0 ], [ "mixmuz.ru", 0 ], [ "myshared.ru", 0 ], [ "myzcloud.me", 0 ], [ "n-torrents.org", 0 ], [ "sims3pack.ru", 0 ], [ "wallegend.net", 0 ], [ "wdho.ru", 0 ], [ "studizba.com", 1 ], [ "surl.li", 1 ], [ "muzlan.top", 2 ], [ "mp3crown.cc", 3 ], [ "sorokam.ru", 4 ], [ "bitshare.link", 5 ], [ "kinokong.pro", 6 ], [ "uakino.club", 6 ], [ "win-lite.site", 6 ], [ "vgtimes.ru", 7 ], [ "startgamer.ru", 8 ], [ "3mod.ru", 9 ], [ "iblitzmods.ru", 9 ], [ "wowskill.ru", 10 ], [ "diplomsrazu.ru", 11 ], [ "igrozoom.ru", 11 ], [ "ru-minecraft.ru", 11 ], [ "softomania.net", 11 ], [ "vip-mods.ru", 11 ], [ "warezok.net", 11 ], [ "windows-driver.com", 11 ], [ "windows-driver.net", 11 ], [ "windows-program.com", 11 ] ]), o = new Map([]), n = new Map([]);
        function s(t = "", r = "", o = "") {
            ...
            i = !1 === isNaN(i) && isFinite(i) ? Math.min(Math.max(i, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, t, r) {
                    const [o, a] = r;
                    return -1 !== s && a !== s || !n.test(o.toString()) || (r[1] = a * i), e.apply(t, r);
                }
            });
        }
        const i = [];
