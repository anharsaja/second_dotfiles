...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/chp_?ad/" ] ], o = new Map([ [ "193.142.147.230", 0 ], [ "5.253.86.213", 0 ], [ "ainzscans.net", 0 ], [ "igobokep.cam", 0 ], [ "jenismac.com", 0 ], [ "siimanga.cyou", 0 ] ]), n = new Map([]), r = new Map([]);
        function s(t = "") {
            ...
            }(), n = o.makeLogPrefix("noeval-if", t), r = o.patternToRegex(t);
            window.eval = new Proxy(window.eval, {
                apply: function(e, s, c) {
                    const i = String(c[0]);
                    if ("" === t || !r.test(i)) return ("" === t || o.logLevel > 1) && o.uboLog(n, "Not prevented:\n", i), 
                    Reflect.apply(e, s, c);
                    o.uboLog(n, "Prevented:\n", i);
                }
            });
        }
        const c = [];
