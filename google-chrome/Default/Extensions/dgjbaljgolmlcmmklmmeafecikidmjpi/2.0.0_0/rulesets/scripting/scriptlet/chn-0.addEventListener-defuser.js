...
(() => {
    const e = function() {
        const e = {}, t = [ [ "error", "event.target.tagName" ], [ "", "showRemoveAdBlocker" ], [ "DOMContentLoaded", "document.createElement" ] ], n = new Map([ [ "rjno1.com", 0 ], [ "xiebruce.top", 1 ], [ "85tube.com", 2 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
