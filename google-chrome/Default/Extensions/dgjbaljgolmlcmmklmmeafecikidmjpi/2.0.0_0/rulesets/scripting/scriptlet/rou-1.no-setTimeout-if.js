...
(() => {
    const e = function() {
        const e = {}, t = [ [ "ai_" ], [ "adsbygoogle" ], [ "show" ], [ "ai_adb" ] ], o = new Map([ [ "turdanews.net", 0 ], [ "vwforum.ro", 1 ], [ "bloground.ro", 2 ], [ "boardingpass.ro", 3 ] ]), r = new Map([]), n = new Map([]);
        function s(t = "", o = "") {
            ...
            self.setTimeout = new Proxy(self.setTimeout, {
                apply: function(e, a, l) {
                    ...
                    let f;
                    return "" !== t && (f = c.test(g) !== s), !1 !== f && void 0 !== o && (f = (p === o || isNaN(p) && isNaN(o)) !== i), 
                    f && (l[0] = function() {}, r.uboLog(n, `Prevented:\n${g}\n${p}`)), Reflect.apply(e, a, l);
                },
