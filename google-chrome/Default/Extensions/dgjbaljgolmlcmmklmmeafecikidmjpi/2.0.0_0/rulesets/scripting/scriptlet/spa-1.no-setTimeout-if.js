...
(() => {
    const e = function() {
        const e = {}, t = [ [ "ad blocker" ], [ "Promise[\\'all\\'](urls" ], [ "/adBlock|\\.height\\(\\)/" ], [ "checkAdblockUser" ], [ "_0x" ], [ "Por favor, desative" ], [ "/Adblock|\\.height\\(\\)/" ], [ "]]=== 0" ], [ ".adsbygoogle" ], [ "adsbygoogle" ], [ "0=== _0x" ], [ "hasAdblock" ], [ "cicklow_" ], [ "/Tamamo_Blocker|aadb_recheck/" ], [ "adJsView" ], [ "window.location.href" ], [ "adsdirect" ] ], o = new Map([ [ "packsmega.info", 0 ], [ "peliculas8k.com", 1 ], [ "guiacripto.online", 2 ], [ "zona-leros.com", 3 ], [ "xerifetech.com", 4 ], [ "suaads.com", 5 ], [ "reidoplacar.com", 5 ], [ "suaurl.com", [ 5, 15 ] ], [ "guianoticiario.net", 6 ], [ "resenhasglobais.com", 7 ], [ "tecword.info", 7 ], [ "smartdoing.tech", 7 ], [ "vivercomsaude.online", 7 ], [ "escplus.es", 8 ], [ "genshinpro.com.br", 9 ], [ "it-swarm-es.com", 9 ], [ "manchetehoje.xyz", 10 ], [ "dicasgostosas.com", 11 ], [ "hartico.com", 12 ], [ "seriesdonghua.com", 13 ], [ "mundodonghua.com", 13 ], [ "forodecostarica.com", 14 ], [ "seriesgratis.biz", 16 ] ]), r = new Map([]), n = new Map([]);
        function s(t = "", o = "") {
            ...
            }(), n = r.makeLogPrefix("prevent-setTimeout", t, o), s = "!" === t.charAt(0);
            ...
            self.setTimeout = new Proxy(self.setTimeout, {
                apply: function(e, a, l) {
                    ...
                    d && (l[0] = function() {}, r.uboLog(n, `Prevented:\n${g}\n${p}`)), Reflect.apply(e, a, l);
                },
