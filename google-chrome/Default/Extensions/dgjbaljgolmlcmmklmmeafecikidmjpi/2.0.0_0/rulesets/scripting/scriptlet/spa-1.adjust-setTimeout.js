        ...
        function s(t = "", o = "", r = "") {
            ...
            i = !1 === isNaN(i) && isFinite(i) ? Math.min(Math.max(i, .001), 50) : .05, self.setTimeout = new Proxy(self.setTimeout, {
                apply: function(e, t, o) {
                    const [r, a] = o;
                    return -1 !== s && a !== s || !n.test(r.toString()) || (o[1] = a * i), e.apply(t, o);
                }
            });
        }
        const i = [];
