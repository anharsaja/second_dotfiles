...
!function() {
    ...
    function r(e = "", o = "", a = "") {
        ...
        !function(e, o) {
            const a = e => {
                ...
                for (const e of a) {
                    const a = `${e}`;
                    if (!1 !== o.hasOwnProperty(a)) return o[a];
                }
                return 0;
            }, t = a(o);
            if (a(document.readyState) >= t) return void e();
            const r = i(), c = [ "readystatechange", () => {
                a(document.readyState) < t || (e(), r.removeEventListener.apply(document, c));
            }, {
                capture: !0
            } ];
            r.addEventListener.apply(document, c);
        }((() => {
            l(), m.observe(document, {
                attributes: !0,
                attributeFilter: [ "class" ],
                childList: !0,
                subtree: !0
            });
        }), /\bcomplete\b/.test(a) ? "idle" : "loading");
    }
    function i() {
        if (e.safeSelf) return e.safeSelf;
        const o = globalThis, a = {
            Array_from: Array.from,
            Error: o.Error,
            Function_toStringFn: o.Function.prototype.toString,
            Function_toString: e => a.Function_toStringFn.call(e),
            ...
            JSON_parse: (...e) => a.JSON_parseFn.call(a.JSON, ...e),
            JSON_stringify: (...e) => a.JSON_stringifyFn.call(a.JSON, ...e),
            log: void 0,
            logLevel: 0,
            makeLogPrefix(...e) {
            ...
            initPattern(e, o = {}) {
                ...
                const a = !0 !== o.canNegate || !1 === e.startsWith("!");
                !1 === a && (e = e.slice(1));
                const t = /^\/(.+)\/([gimsu]*)$/.exec(e);
                return null !== t ? {
                    re: new this.RegExp(t[1], t[2] || o.flags),
                    expect: a
                } : void 0 !== o.flags ? {
            ...
            patternToRegex(e, o, a = !1) {
                if ("" === e) return /^/;
                const t = /^\/(.+)\/([gimsu]*)$/.exec(e);
                if (null === t) {
                    const t = this.escapeRegexChars(e);
                    return new RegExp(a ? `^${t}$` : t, o);
                }
                try {
                    return new RegExp(t[1], t[2] || void 0);
                } catch (e) {}
                return /^/;
            },
            getExtraArgs(e, o = 0) {
                const a = e.slice(o).reduce(((e, o, a, t) => {
                    if (0 == (1 & a)) {
                        const o = t[a + 1], s = /^\d+$/.test(o) ? parseInt(o, 10) : o;
                        e.push([ t[a], s ]);
                    }
                    return e;
                }), []);
            ...
            onIdle: (e, a) => o.requestIdleCallback ? o.requestIdleCallback(e, a) : o.requestAnimationFrame(e)
        };
        if (e.safeSelf = a, void 0 === e.bcSecret) return a;
        const t = new o.BroadcastChannel(e.bcSecret);
        let s = [];
        return a.logLevel = e.logLevel || 1, a.sendToLogger = (e, ...o) => {
            if (0 === o.length) return;
            const a = `[${document.location.hostname || document.location.href}]${o.join(" ")}`;
            if (void 0 === s) return t.postMessage({
            ...
            switch (e.data) {
              case "iamready!":
                if (void 0 === s) break;
                s.forEach((({type: e, text: o}) => t.postMessage({
                    what: "messageToLogger",
                    type: e,
                    text: o
                }))), s = void 0;
    ...
    if (0 !== s.size) {
        for (let e = 0; e < n; e++) {
            const o = c.slice(e).join("."), a = s.get(o);
            a && l.push(...a);
        }
        s.clear();
    }
    if (0 !== a.size) {
        const e = e => {
            ...
            if (void 0 !== o) {
                "number" == typeof o && (o = [ o ]);
                for (const e of o) l.includes(e) || d.add(e);
            }
        };
        for (let o = 0; o < n; o++) e(c.slice(o).join("."));
        e("*"), a.clear();
    }
    if (0 !== t.size) {
        const e = n - 1;
        for (let o = 0; o < e; o++) for (let a = e; a > o; a--) {
            const e = c.slice(o, a).join(".");
            let s = t.get(e);
            if (void 0 !== s) {
                "number" == typeof s && (s = [ s ]);
                for (const e of s) l.includes(e) || d.add(e);
            }
        }
        t.clear();
    }
