...
(() => {
    const e = function() {
        const e = {}, t = [ [ "style", "body", "stay" ], [ "oncontextmenu" ], [ "href", '[href*="ad.adverticum.net"]' ], [ "class", 'section[class="life-section l-section-main article-section l-section-article"]' ], [ "style", "body" ] ], r = new Map([ [ "blikk.hu", 0 ], [ "lifestory.hu", 1 ], [ "mindmegette.hu", 2 ], [ "life.hu", 3 ], [ "sorozatwiki.hu", 4 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "", t = "", r = "") {
            ...
            !function(e, t) {
                ...
                l(), !1 !== /\bstay\b/.test(r) && new MutationObserver(u).observe(document, {
                    attributes: !0,
                    attributeFilter: s,
                    childList: !0,
                    subtree: !0
