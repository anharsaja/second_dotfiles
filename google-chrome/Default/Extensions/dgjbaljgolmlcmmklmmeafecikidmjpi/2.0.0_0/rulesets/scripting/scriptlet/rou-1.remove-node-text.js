...
!function() {
    const e = {}, t = [ [ "script", "adsbygoogle" ], [ "script", "/jQuery.*reload/" ], [ "script", "document.head.appendChild" ], [ "script", "ai_adb" ] ], r = new Map([ [ "turdanews.net", 0 ], [ "sampmoduri.ro", 1 ], [ "filme2023.online", 2 ], [ "clujust.ro", 3 ] ]), o = new Map([]), n = new Map([]);
    function s(e, t, ...r) {
        !function(e = "", t = "", r = "") {
            const o = i(), n = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = o.patternToRegex(e, "i", !0), c = o.patternToRegex(t, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = o.patternToRegex(a.condition || "", "ms"), d = (e = !0) => {
                e && p(f.takeRecords()), f.disconnect(), o.logLevel > 1 && o.uboLog(n, "Quitting");
            };
            let g = a.sedCount || 0;
            const u = e => {
                ...
                for (const t of e) for (const e of t.addedNodes) if (!1 !== s.test(e.nodeName) && !u(e)) return void d(!1);
