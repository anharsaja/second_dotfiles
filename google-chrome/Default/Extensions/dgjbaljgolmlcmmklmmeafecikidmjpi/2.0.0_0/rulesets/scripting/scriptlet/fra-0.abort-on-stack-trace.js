...
(() => {
    const e = function() {
        const e = {}, t = [ [ "document.createEvent", "Object.trigger" ] ], r = new Map([ [ "zone-telechargement.moe", 0 ], [ "dl-protect.net", 0 ], [ "annuaire-telechargement.tel", 0 ] ]), n = new Map([]), o = new Map([]);
        function c(e = "", t = "") {
            ...
            const c = function(e, t) {
                ...
                if (-1 === r) {
                    ...
                    return void Object.defineProperty(e, t, {
                        get: function() {
                            if (i(n, o.log)) throw new ReferenceError(s());
                            return r;
                        },
                        set: function(e) {
                            if (i(n, o.log)) throw new ReferenceError(s());
        ...
        function i(e, t = "") {
            const r = a(), n = s(), o = new r.Error(n), c = new URL(self.location.href);
            c.hash = "";
            const i = /(.*?@)?(\S+)(:\d+):\d+\)?$/, l = [];
