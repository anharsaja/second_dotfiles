...
(() => {
    const e = function() {
        const e = {}, t = [ [ "showAds", "true" ], [ "document.blocked_var", "1" ], [ "____ads_js_blocked", "false" ] ], n = new Map([ [ "haaretz.co.il", 0 ], [ "themarker.com", 0 ], [ "www-haaretz-co-il.eu1.proxy.openathens.net", 0 ], [ "www-themarker-com.eu1.proxy.openathens.net", 0 ], [ "www-globes-co-il.eu1.proxy.openathens.net", [ 1, 2 ] ] ]), r = new Map([]), o = new Map([]);
        function s(...e) {
            !function(e = !1, t = "", n = "") {
                if ("" === t) return;
