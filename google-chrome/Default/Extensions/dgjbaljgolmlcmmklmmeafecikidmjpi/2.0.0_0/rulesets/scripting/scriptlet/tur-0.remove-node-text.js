...
!function() {
    const e = {}, t = [ [ "script", "ad_block" ], [ "script", "redirect" ] ], r = new Map([ [ "birsenaltuntas.com", 0 ], [ "m.4khd.com", 1 ] ]), o = new Map([]), n = new Map([]);
    function s(e, t, ...r) {
        !function(e = "", t = "", r = "") {
            const o = i(), n = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = o.patternToRegex(e, "i", !0), c = o.patternToRegex(t, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = o.patternToRegex(a.condition || "", "ms"), g = (e = !0) => {
                e && f(p.takeRecords()), p.disconnect(), o.logLevel > 1 && o.uboLog(n, "Quitting");
            };
            let d = a.sedCount || 0;
            const u = e => {
