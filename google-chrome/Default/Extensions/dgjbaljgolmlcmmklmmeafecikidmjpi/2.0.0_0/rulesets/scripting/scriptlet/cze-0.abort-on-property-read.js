...
(() => {
    const e = function() {
        const e = {}, t = [ [ "App.branding" ], [ "adsAllowed" ], [ "HTMLIFrameElement.prototype.contentWindow" ], [ "Ads" ], [ "detectAdBlocker" ], [ "atob" ], [ "adBlockEnabled" ] ], r = new Map([ [ "cc.cz", 0 ], [ "ctrlv.link", 1 ], [ "games.tiscali.cz", 2 ], [ "parlamentnilisty.cz", 3 ], [ "svetandroida.cz", 4 ], [ "zdopravy.cz", [ 5, 6 ] ] ]), o = new Map([]), n = new Map([]);
        function c(e = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const t = s(), r = t.makeLogPrefix("abort-on-property-read", e), o = function() {
                ...
                const o = t.slice(0, r);
                let s = e[o];
                if (t = t.slice(r + 1), s) return void c(s, t);
