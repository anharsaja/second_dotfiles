...
(() => {
    const e = function() {
        const e = {}, t = [ [ "appearance.extended_auto_start" ], [ "banner.ytcode" ], [ "data", "errors" ], [ "dl bpas" ], [ "isVideoAutoplayMode swUrl" ], [ "results.fixed" ], [ "tiers.TIER_ANY" ], [ "vast" ], [ "result.body.direct" ], [ "[].slot" ] ], r = new Map([ [ "uma.media", 0 ], [ "ivanovonews.ru", 1 ], [ "kufar.by", 2 ], [ "pikabu.ru", [ 2, 4 ] ], [ "1plus1.video", 3 ], [ "igromania.ru", 5 ], [ "kanobu.ru", 5 ], [ "znanija.com", 6 ], [ "aniqit.com", 7 ], [ "anivod.com", 7 ], [ "ashdi.vip", 7 ], [ "kodik.cc", 7 ], [ "kodik.info", 7 ], [ "tortuga.wtf", 7 ], [ "ok.ru", 8 ], [ "touch.mail.ru", 8 ], [ "e.mail.ru", 9 ] ]), n = new Map([]), o = new Map([]);
        function s(e = "", t = "", r = "") {
            ...
            JSON.parse = new Proxy(JSON.parse, {
                apply: function(r, c, l) {
                    const u = Reflect.apply(r, c, l);
                    "" === e && n.uboLog(o, n.JSON_stringify(u, null, 2));
                    const f = i(u, e, t, s, a);
                    return void 0 === f ? u : (n.uboLog(o, "Pruned"), n.logLevel > 1 && n.uboLog(o, `After pruning:\n${n.JSON_stringify(f, null, 2)}`), 
                    f);
                }
            });
        }
        function i(e, t, r, n = {
            ...
            if (!0 !== n.matchAll && !1 === function(e, t = "") {
                ...
                const l = a.join("\t"), u = !0 !== e.matchAll && r.testPattern(e, l);
                return ("all" === t || "match" === t && u || "nomatch" === t && !u) && r.uboLog(l.replace(/\t/g, "\n")), 
                u;
            }(n, o.logstack)) return;
            ...
            let u = "nomatch";
            if (i.mustProcess(e, l)) for (const t of s) a(e, t, !0) && (u = "match");
        ...
        if (0 !== r.size) {
            const e = e => {
                ...
                if (void 0 !== t) {
                    "number" == typeof t && (t = [ t ]);
                    for (const e of t) p.includes(e) || f.add(e);
                }
            };
        ...
        if (0 !== n.size) {
            ...
            for (let t = 0; t < e; t++) for (let r = e; r > t; r--) {
                ...
                if (void 0 !== o) {
                    "number" == typeof o && (o = [ o ]);
                    for (const e of o) p.includes(e) || f.add(e);
                }
            }
            n.clear();
        }
