...
!function() {
    const e = {}, t = [ [ "#cmtFormTable textarea", "cols", "50" ] ], r = new Map([ [ "mlbpark.donga.com", 0 ] ]), o = new Map([]), n = new Map([]);
    function s(e = "", t = "", r = "") {
        if ("" === e) return;
        if ("" === t) return;
        ...
        const g = e => {
            ...
            !1 !== t && (f = self.requestAnimationFrame((() => {
                f = void 0, a();
            })));
        };
        !function(e, t) {
            ...
            !1 !== a() && (l = new MutationObserver(g), l.observe(document.body, {
                subtree: !0,
                childList: !0
            }));
        }));
