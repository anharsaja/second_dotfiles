...
(() => {
    const e = function() {
        const e = {}, t = [ [ "BetterJsPop" ], [ "canRunAds" ], [ "_renderAdblock" ] ], r = new Map([ [ "player.eltitbus.xyz", 0 ], [ "player.filmux.to", 0 ], [ "simpsonaionline.net", 1 ], [ "15min.lt", 2 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "") {
