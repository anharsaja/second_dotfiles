        ...
        function c(...t) {
            !function(e) {
                ...
                !function(t = "", r = "", n = "") {
                    ...
                    let p, g, d = window;
                    for (;p = f.shift(), 0 !== f.length && p in d != 0; ) if (d = d[p], d instanceof Object == 0) return;
                    let m = Object.getOwnPropertyDescriptor(d, p);
                    m instanceof Object != 0 && m.get instanceof Function != 0 || (g = d[p], m = void 0), 
                    function(t) {
                    ...
                    try {
                        Object.defineProperty(d, p, {
                            get: function() {
                                return v(), m instanceof Object ? m.get.call(d) : g;
                            },
                            set: function(e) {
                                v(), m instanceof Object ? m.set.call(d, e) : g = e;
                            }
                        });
                    } catch (e) {
                        o.uboErr(c, `Error: ${e}`);
