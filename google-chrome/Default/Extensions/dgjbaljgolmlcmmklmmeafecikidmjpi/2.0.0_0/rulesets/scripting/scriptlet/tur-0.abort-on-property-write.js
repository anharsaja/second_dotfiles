...
(() => {
    const e = function() {
        const e = {}, t = [ [ "adregain_wall" ], [ "rInt" ], [ "openRandomUrl" ], [ "popURL" ], [ "onPopUnderLoaded" ], [ "window.onload" ], [ "yeniSekmeAdresi" ], [ "adx" ] ], r = new Map([ [ "memoryhackers.org", 0 ], [ "r10.net", 1 ], [ "yeppuu.com", 2 ], [ "dizipia.com", 3 ], [ "birasyadizi.com", 4 ], [ "seyredeger.com", 4 ], [ "indirmedenfilmizle.vip", 4 ], [ "dizilost.com", [ 4, 5 ] ], [ "mixizle.com", 6 ], [ "fullhdabifilm.com", 6 ], [ "hdmixfilim.com", 6 ] ]), o = new Map([ [ "4kfilmizlesene", 7 ] ]), n = new Map([]);
        function i(e = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const t = s(), r = t.makeLogPrefix("abort-on-property-write", e), o = function() {
