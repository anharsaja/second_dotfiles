...
(() => {
    const e = function() {
        const e = {}, t = [ [ "siteParams.aabMessage" ], [ "adParams siteParams.aabMessage" ], [ "ads.enableAntiAdBlocking" ], [ "ads.*.default ads.*.url ads.enableMidrolls", "ads" ], [ "applaunch.data.player.features.ad.enabled applaunch.data.player.features.ad.dai.enabled", "appName" ] ], r = new Map([ [ "commentcamarche.net", 0 ], [ "linternaute.com", 1 ], [ "canalplus.com", [ 2, 3 ] ], [ "rtlplay.be", 4 ] ]), n = new Map([]), o = new Map([]);
        function s(e = "", t = "", r = "") {
            const n = c(), o = n.makeLogPrefix("json-prune", e, t, r), s = n.initPattern(r, {
                canNegate: !0
            }), i = n.getExtraArgs(Array.from(arguments), 3);
        ...
        function a(e, t, r, n = {
            ...
            if (void 0 === a.mustProcess && (a.mustProcess = (e, t) => {
                for (const r of t) if (!1 === i(e, r)) return !1;
                return !0;
            }), 0 === s.length) return;
            let f = "nomatch";
            if (a.mustProcess(e, l)) for (const t of s) i(e, t, !0) && (f = "match");
        ...
        function i(e, t, r = !1) {
            ...
            for (;;) {
                ...
                if ("[-]" === t && Array.isArray(n)) {
                    let e = n.length;
                    for (;e--; ) !1 !== i(n[e], s) && (n.splice(e, 1), a = !0);
                    return a;
                }
                if ("{-}" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== i(n[e], s) && (delete n[e], a = !0);
                    return a;
                }
                if ("[]" === t && Array.isArray(n) || "{}" === t && n instanceof Object || "*" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== i(n[e], s, r) && (a = !0);
                    return a;
                }
