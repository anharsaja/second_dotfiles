...
(() => {
    const e = function() {
        const e = {}, t = [ [ "", "hblocked" ], [ "load", "hblocked" ] ], n = new Map([ [ "haaretz.co.il", 0 ], [ "themarker.com", 0 ], [ "www-haaretz-co-il.eu1.proxy.openathens.net", [ 0, 1 ] ], [ "www-themarker-com.eu1.proxy.openathens.net", 0 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
            const r = c(), o = r.getExtraArgs(Array.from(arguments), 2), s = r.makeLogPrefix("prevent-addEventListener", t, n), a = r.patternToRegex(t, void 0, !0), i = r.patternToRegex(n), l = (function(t) {
                ...
                const o = r.RegExp_test.call(a, t), s = r.RegExp_test.call(i, n), c = o && s;
                ...
                (() => {
                    const e = {
                        apply: function(e, o, c) {
                            let a, i;
                            try {
                                a = String(c[0]), "function" == typeof c[1] ? i = String(r.Function_toString(c[1])) : "object" == typeof c[1] && null !== c[1] ? "function" == typeof c[1].handleEvent && (i = String(r.Function_toString(c[1].handleEvent))) : i = String(c[1]);
                            } catch (e) {}
                            if ("" === t && "" === n) r.uboLog(s, `Called: ${a}\n${i}\n${p(o)}`); else if (u(o, a, i)) return r.uboLog(s, `Prevented: ${a}\n${i}\n${p(o)}`);
