...
(() => {
    const e = function() {
        const e = {}, t = [ [ "*", "nativeConfig" ], [ "*", "list.*.link.ad list.*.link.kicker" ], [ "ads" ], [ "ad" ] ], r = new Map([ [ "moorzon.com", 0 ], [ "msn.cn", 1 ], [ "v.qq.com", 2 ], [ "new.qq.com", 2 ], [ "qq.com", 3 ] ]), n = new Map([]), o = new Map([ [ "work.weixin.qq.com", [ 3 ] ] ]);
        function s(e = "", t = "", r = "") {
