...
(() => {
    const e = function() {
        const e = {}, t = [ [ "adsBlocked" ], [ "ai_front" ], [ "disableSelection" ], [ "disable_keystrokes" ], [ "document.oncontextmenu" ], [ "document.ondragstart" ], [ "document.onselectstart" ], [ "fetch" ], [ "keepAdblock" ], [ "window.yaProxy" ], [ "mailruEnabled" ] ], r = new Map([ [ "24pdd.ru", 0 ], [ "doctorrouter.ru", 1 ], [ "ranobe-novels.ru", 1 ], [ "tests24.su", 1 ], [ "ufchgu.ru", [ 2, 3 ] ], [ "fssp.gov.ru", [ 4, 5, 6 ] ], [ "southpark.su", [ 4, 5, 6 ] ], [ "turkcinema.org", [ 4, 5, 6 ] ], [ "phys-kids.com", 7 ], [ "gamemag.ru", 8 ], [ "kakprosto.ru", 9 ], [ "ok.ru", 10 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const t = c(), r = t.makeLogPrefix("abort-on-property-write", e), o = function() {
