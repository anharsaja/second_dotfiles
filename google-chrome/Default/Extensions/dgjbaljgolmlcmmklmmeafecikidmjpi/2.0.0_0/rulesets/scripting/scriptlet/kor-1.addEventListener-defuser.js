...
(() => {
    const e = function() {
        const e = {}, t = [ [ "hashchange", "#viewus-explore-more" ], [ "DOMContentLoaded", "link.coupang.com" ] ], n = new Map([ [ "youtu.co", 0 ], [ "dfast.kr", 0 ], [ "whathappen.co.kr", 1 ], [ "momkim.co.kr", 1 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
