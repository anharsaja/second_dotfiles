...
(() => {
    const e = function() {
        const e = {}, t = [ [ "load", "isAdblock" ], [ "DOMContentLoaded", "adsbygoogle" ], [ "click", "Popup" ], [ "DOMContentLoaded", "interstitial" ] ], n = new Map([ [ "cyclismactu.net", 0 ], [ "lecourrier-du-soir.com", 1 ], [ "player.melaniezettofrais.online", 2 ], [ "macg.co", 3 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
                ...
                (() => {
                    const e = {
                        apply: function(e, o, c) {
                            ...
                            if ("" === t && "" === n) r.uboLog(s, `Called: ${i}\n${a}\n${p(o)}`); else if (d(o, i, a)) return r.uboLog(s, `Prevented: ${i}\n${a}\n${p(o)}`);
