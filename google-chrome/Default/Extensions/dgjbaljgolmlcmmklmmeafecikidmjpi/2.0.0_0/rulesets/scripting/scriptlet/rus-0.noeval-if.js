...
(() => {
    const e = function() {
        const e = {}, t = [ [ "ShadowRoot" ], [ "adsBlocked" ] ], o = new Map([ [ "otzovik.com", 0 ], [ "kvadratmetr.uz", 1 ], [ "oligarx.uz", 1 ], [ "tehnar.net.ua", 1 ] ]), r = new Map([]), n = new Map([]);
        function s(t = "") {
            ...
            window.eval = new Proxy(window.eval, {
                apply: function(e, s, c) {
                    const a = String(c[0]);
                    if ("" === t || !n.test(a)) return ("" === t || o.logLevel > 1) && o.uboLog(r, "Not prevented:\n", a), 
                    Reflect.apply(e, s, c);
