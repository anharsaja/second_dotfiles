...
(() => {
    const e = function() {
        const e = {}, t = [ [ "window.location" ], [ "adsbygoogle" ], [ "this[_0x" ], [ "var _0x" ] ], r = new Map([ [ "chat.babel.com", 0 ], [ "lecourrier-du-soir.com", 1 ], [ "zone-telechargement.work", 2 ], [ "dl-protect.info", 3 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "") {
