...
(() => {
    const e = function() {
        const e = {}, t = [ [ "reward_countdown" ], [ "timerId", "1000" ], [ ".run()}", "1000" ] ], r = new Map([ [ "shindanmaker.com", 0 ], [ "portal.game.sycasualgames.com", 1 ], [ "collepic.net", 2 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "", n = "") {
            ...
            a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, t, r) {
                    const [n, c] = r;
                    return -1 !== s && c !== s || !o.test(n.toString()) || (r[1] = c * a), e.apply(t, r);
                }
            });
        }
        const a = [];
