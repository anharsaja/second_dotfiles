...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/contextmenu|copy|cut/", 'return"undefined"' ], [ "contextmenu", "preventDefault" ], [ "contextmenu" ], [ "", "t.preventDefault" ], [ "load", "contextmenu" ], [ "click", "720" ], [ "copy", "throw" ], [ "click", 'return"undefined"', "elements", "a.indirect[data-get]" ] ], n = new Map([ [ "bizma.ir", 0 ], [ "app.blubank.com", 1 ], [ "elmefarda.com", 2 ], [ "s-moshaver.com", 2 ], [ "ganjipakhsh.com", 3 ], [ "javan-musics.com", 4 ], [ "tabanmusic.com", 4 ], [ "texahang.org", 4 ], [ "iran-music.com", 4 ], [ "mopon.ir", 5 ], [ "noorlib.ir", 6 ], [ "subkade.ir", 7 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
            const r = c(), o = r.getExtraArgs(Array.from(arguments), 2), s = r.makeLogPrefix("prevent-addEventListener", t, n), i = r.patternToRegex(t, void 0, !0), a = r.patternToRegex(n), l = (function(t) {
                ...
                return (!c || void 0 === l || !1 !== (!!((u = e) && u.matches && u.matches(l)) || Array.from(document.querySelectorAll(l)).includes(u))) && c;
                var u;
            };
            !function(e, t) {
                const n = e => {
                ...
                (() => {
                    const e = {
                        apply: function(e, o, c) {
                            ...
                            if ("" === t && "" === n) r.uboLog(s, `Called: ${i}\n${a}\n${u(o)}`); else if (p(o, i, a)) return r.uboLog(s, `Prevented: ${i}\n${a}\n${u(o)}`);
