...
!function() {
    const e = {}, t = [ [ 'iframe[data-src-cmplz][src="about:blank"]', "src", "[data-src-cmplz]" ], [ ".video-skip[data-time]", "data-time", "0" ], [ ".lazy", "src", "[data-sco-src]" ] ], r = new Map([ [ "statisticsanddata.org", 0 ], [ "18kalebettv.xyz", 1 ], [ "19kalebettv.xyz", 1 ], [ "rocketnews24.com", 2 ], [ "soranews24.com", 2 ], [ "youpouch.com", 2 ] ]), o = new Map([]), n = new Map([]);
    function s(e = "", t = "", r = "") {
        if ("" === e) return;
        if ("" === t) return;
