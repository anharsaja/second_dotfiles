...
(() => {
    const e = function() {
        const e = {}, t = [ [ "i--", "", "0.02" ], [ "Clipboard", "1000", "0.001" ], [ "loadexternal", "1000" ] ], o = new Map([ [ "onlinegiftools.com", 1 ], [ "onlinejpgtools.com", 1 ], [ "onlinepngtools.com", 1 ], [ "onlinestringtools.com", 1 ], [ "onlinetexttools.com", 1 ], [ "onlinetools.com", 1 ], [ "remixsearch.es", 2 ] ]), n = new Map([ [ "bluemediafile", 0 ] ]), r = new Map([]);
        function s(t = "", o = "", n = "") {
            ...
            i = !1 === isNaN(i) && isFinite(i) ? Math.min(Math.max(i, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, t, o) {
                    const [n, c] = o;
                    return -1 !== s && c !== s || !r.test(n.toString()) || (o[1] = c * i), e.apply(t, o);
                }
            });
        }
        const i = [];
    ...
    if ("object" != typeof wrappedJSObject) return e();
    {
        ...
        try {
            ...
            const r = new t.Blob(...t.uBOL_adjustSetInterval);
            n = t.URL.createObjectURL(r);
            const s = t.document;
            o = s.createElement("script"), o.async = !1, o.src = n, (s.head || s.documentElement || s).append(o);
        } catch (e) {}
        n && (o && o.remove(), t.URL.revokeObjectURL(n)), delete t.uBOL_adjustSetInterval;
    }
})();