...
(() => {
    const e = function() {
        const e = {}, t = [ [ "entity.commercial" ] ], r = new Map([ [ "m.nivod5.tv", 0 ], [ "m1.nivod.tv", 0 ], [ "m.nivod4.tv", 0 ] ]), n = new Map([]), o = new Map([]);
        function s(e = "", t = "") {
            self.eval = new Proxy(self.eval, {
                apply(r, n, o) {
                    const s = Reflect.apply(r, n, o);
                    return "object" == typeof s && c(s, e, t) || s;
                }
            });
        }
        function c(e, t, r, n = {
            ...
            let f = "nomatch";
            if (c.mustProcess(e, l)) for (const t of s) i(e, t, !0) && (f = "match");
        ...
        function i(e, t, r = !1) {
            ...
            for (;;) {
                ...
                if ("[-]" === t && Array.isArray(n)) {
                    let e = n.length;
                    for (;e--; ) !1 !== i(n[e], s) && (n.splice(e, 1), c = !0);
                    return c;
                }
                if ("{-}" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== i(n[e], s) && (delete n[e], c = !0);
                    return c;
                }
                if ("[]" === t && Array.isArray(n) || "{}" === t && n instanceof Object || "*" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== i(n[e], s, r) && (c = !0);
                    return c;
                }
