...
(() => {
    const e = function() {
        const e = {}, t = [ [ "require.0.3.0.__bbox.define.[].2.is_linkshim_supported require.0.3.0.__bbox.define.[].2.click_ids" ], [ "auxiliaryUi.messageRenderers.upsellDialogRenderer" ] ], r = new Map([ [ "www.facebook.com", 0 ], [ "m.youtube.com", 1 ], [ "music.youtube.com", 1 ], [ "tv.youtube.com", 1 ], [ "www.youtube.com", 1 ], [ "youtubekids.com", 1 ] ]), n = new Map([]), o = new Map([]);
        function s(e = "", t = "", r = "") {
