...
!function() {
    const e = {}, t = [ [ "/protect?" ], [ "/link-" ], [ "/telephone-service" ], [ "/^/" ], [ "/soft98" ] ], o = new Map([ [ "norton.com", 0 ], [ "soft98.ir", 1 ], [ "sysban.ir", 2 ], [ "smostafa.ir", 3 ], [ "coffeete.ir", 4 ] ]), r = new Map([]), n = new Map([ [ "forum.soft98.ir", [ 1 ] ] ]);
    function s(t = "") {
        ...
        let r = "";
        /^\/.*\/$/.test(t) ? r = window.location.href : "" !== t && (r = `${window.location.pathname}${window.location.search}`);
        try {
            o.patternToRegex(t).test(r) && window.close();
        } catch (e) {}
    }
    const i = [];
    try {
