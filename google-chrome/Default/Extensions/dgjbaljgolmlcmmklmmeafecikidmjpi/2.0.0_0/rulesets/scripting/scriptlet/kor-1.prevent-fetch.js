...
(() => {
    const e = function() {
        const e = {}, t = [ [ "/^https.\\/\\/videoads\\.kakao\\.com\\/adserver\\/api\\/v[0-9]{1", "2}\\/vmap$/" ], [ "imasdk.googleapis.com/js/sdkloader/ima3.js" ], [ "pagead2.googlesyndication.com/pagead/js/adsbygoogle.js" ], [ "www3.doubleclick.net" ] ], r = new Map([ [ "tv.kakao.com", 0 ], [ "play-tv.kakao.com", 0 ], [ "kakaotv.daum.net", 0 ], [ "spotvnow.co.kr", [ 1, 2 ] ], [ "blackkiwi.net", 3 ] ]), o = new Map([]), n = new Map([]);
        function s(t = "", r = "") {
