...
(() => {
    const e = function() {
        const e = {}, t = [ [ "DAB", "noopFunc" ], [ "BannerManager", "undefined" ] ], n = new Map([ [ "forum.fok.nl", 0 ], [ "hardware.info", 1 ] ]), r = new Map([]), o = new Map([]);
        function i(...e) {
            !function(e = !1, t = "", n = "") {
                if ("" === t) return;
                ...
                function c(t, n) {
                    ...
                    let f = !1;
                    const l = function(t) {
                        return !e && (!!f || (f = null != t && null != u && typeof t != typeof u, f && r.uboLog(o, `Aborted because value set to ${t}`), 
                        f));
                    }, p = function(e, t, n, i) {
        ...
        if (0 !== r.size) {
            ...
            for (let t = 0; t < e; t++) for (let n = e; n > t; n--) {
                ...
                if (void 0 !== o) {
                    "number" == typeof o && (o = [ o ]);
                    for (const e of o) f.includes(e) || u.add(e);
                }
            }
            r.clear();
        }
