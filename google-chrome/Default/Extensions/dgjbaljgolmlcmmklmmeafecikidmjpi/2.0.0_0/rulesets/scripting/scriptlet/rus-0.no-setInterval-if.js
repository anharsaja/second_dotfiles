...
(() => {
    const e = function() {
        const e = {}, t = [ [ "_0x", "5000" ], [ "clientHeight" ], [ "debugger" ], [ "move_string" ], [ "replaceWith" ] ], n = new Map([ [ "howdyho.net", 0 ], [ "fatcatslim.ru", 1 ], [ "aniu.ru", 2 ], [ "liveball.uno", 2 ], [ "anime-chan.me", 3 ], [ "volyninfo.com", 4 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
