...
(() => {
    const o = function() {
        ...
        function n(...o) {
            !function(o = !1, c = "", e = "") {
                ...
                function r(c, e) {
                    ...
                    let l = !1;
                    const d = function(c) {
                        return !o && (!!l || (l = null != c && null != i && typeof c != typeof i, l && m.uboLog(t, `Aborted because value set to ${c}`), 
                        l));
                    }, u = function(o, c, e, n) {
                        if (!1 === n.init(e ? o[c] : i)) return;
                        const a = m.Object_getOwnPropertyDescriptor(o, c);
                        let r, s;
                        a instanceof m.Object && (o[c] = i, a.get instanceof Function && (r = a.get), a.set instanceof Function && (s = a.set));
                        try {
                            m.Object_defineProperty(o, c, {
                                configurable: e,
                                get: () => (void 0 !== r && r(), n.getter()),
                                set(o) {
                                    void 0 !== s && s(o), n.setter(o);
                                }
                            }), m.uboLog(t, "Trap installed");
                        } catch (o) {
                            m.uboErr(t, o);
                        }
                    }, h = function(o, c) {
                        const e = c.indexOf(".");
                        if (-1 === e) return void u(o, c, !1, {
                            v: void 0,
                            init: function(o) {
                                return !d(o) && (this.v = o, !0);
                            },
                            getter: function() {
                                return document.currentScript === s ? this.v : (m.uboLog(t, "Property read"), i);
                            },
                            setter: function(o) {
                                !1 !== d(o) && (i = o);
                            }
                        });
                        const n = c.slice(0, e), a = o[n];
                        c = c.slice(e + 1), a instanceof m.Object || "object" == typeof a && null !== a ? h(a, c) : u(o, n, !0, {
                            v: void 0,
                            init: function(o) {
                                return this.v = o, !0;
                            },
                            ...
                            setter: function(o) {
                                this.v = o, o instanceof m.Object && h(o, c);
                            }
                        });
                    };
                    h(window, c);
                ...
                !function(o, c) {
                    const e = o => {
                        const c = {
                            ...
                            idle: 3,
                            3: 3
                        }, e = Array.isArray(o) ? o : [ o ];
                        for (const o of e) {
                            const e = `${o}`;
                            if (!1 !== c.hasOwnProperty(e)) return c[e];
                        }
                        return 0;
                    }, m = e(c);
                    if (e(document.readyState) >= m) return void o();
                    const n = a(), r = [ "readystatechange", () => {
                        e(document.readyState) < m || (o(), n.removeEventListener.apply(document, r));
                    }, {
                        capture: !0
                    } ];
                    n.addEventListener.apply(document, r);
                }((() => {
                    r(c, e);
                }), n.runAt);
            }(!1, ...o);
        ...
        function a() {
            ...
            const c = globalThis, e = {
                Array_from: Array.from,
                Error: c.Error,
                Function_toStringFn: c.Function.prototype.toString,
                ...
                RegExp: c.RegExp,
                RegExp_test: c.RegExp.prototype.test,
                RegExp_exec: c.RegExp.prototype.exec,
                Request_clone: c.Request.prototype.clone,
                XMLHttpRequest: c.XMLHttpRequest,
                addEventListener: c.EventTarget.prototype.addEventListener,
                removeEventListener: c.EventTarget.prototype.removeEventListener,
                fetch: c.fetch,
                JSON: c.JSON,
                JSON_parseFn: c.JSON.parse,
                JSON_stringifyFn: c.JSON.stringify,
                ...
                initPattern(o, c = {}) {
                    ...
                    const e = !0 !== c.canNegate || !1 === o.startsWith("!");
                    !1 === e && (o = o.slice(1));
                    const m = /^\/(.+)\/([gimsu]*)$/.exec(o);
                    return null !== m ? {
                        re: new this.RegExp(m[1], m[2] || c.flags),
                        expect: e
                    } : void 0 !== c.flags ? {
                        re: new this.RegExp(this.escapeRegexChars(o), c.flags),
                        expect: e
                    } : {
                        pattern: o,
                        expect: e
                ...
                testPattern(o, c) {
                    return !!o.matchAll || (o.re ? this.RegExp_test.call(o.re, c) === o.expect : c.includes(o.pattern) === o.expect);
                },
                patternToRegex(o, c, e = !1) {
                    if ("" === o) return /^/;
                    const m = /^\/(.+)\/([gimsu]*)$/.exec(o);
                    if (null === m) {
                        const m = this.escapeRegexChars(o);
                        return new RegExp(e ? `^${m}$` : m, c);
                    }
                    try {
                ...
                getExtraArgs(o, c = 0) {
                    const e = o.slice(c).reduce(((o, c, e, m) => {
                        if (0 == (1 & e)) {
                            const c = m[e + 1], t = /^\d+$/.test(c) ? parseInt(c, 10) : c;
                            o.push([ m[e], t ]);
                        }
                        return o;
                    }), []);
                    return this.Object_fromEntries(e);
                },
                onIdle: (o, e) => c.requestIdleCallback ? c.requestIdleCallback(o, e) : c.requestAnimationFrame(o)
            };
            if (o.safeSelf = e, void 0 === o.bcSecret) return e;
            const m = new c.BroadcastChannel(o.bcSecret);
            let t = [];
            return e.logLevel = o.logLevel || 1, e.sendToLogger = (o, ...c) => {
                if (0 === c.length) return;
                const e = `[${document.location.hostname || document.location.href}]${c.join(" ")}`;
                if (void 0 === t) return m.postMessage({
                ...
                switch (o.data) {
                  case "iamready!":
                    if (void 0 === t) break;
                    t.forEach((({type: o, text: c}) => m.postMessage({
                        what: "messageToLogger",
                        type: o,
                        text: c
                    }))), t = void 0;
        ...
        if (0 !== t.size) {
            for (let o = 0; o < s; o++) {
                const c = r.slice(o).join("."), e = t.get(c);
                e && l.push(...e);
            }
            t.clear();
        }
        if (0 !== e.size) {
            const o = o => {
                ...
                if (void 0 !== c) {
                    "number" == typeof c && (c = [ c ]);
                    for (const o of c) l.includes(o) || i.add(o);
                }
            };
            for (let c = 0; c < s; c++) o(r.slice(c).join("."));
            o("*"), e.clear();
        }
        if (0 !== m.size) {
            const o = s - 1;
            for (let c = 0; c < o; c++) for (let e = o; e > c; e--) {
                const o = r.slice(c, e).join(".");
                let t = m.get(o);
                if (void 0 !== t) {
                    "number" == typeof t && (t = [ t ]);
                    for (const o of t) l.includes(o) || i.add(o);
                }
            }
            m.clear();
        }
    ...
    if ("object" != typeof wrappedJSObject) return o();
    {
        const c = self.wrappedJSObject;
        let e, m;
        try {
            c.uBOL_setConstant = cloneInto([ [ "(", o.toString(), ")();" ], {
                type: "text/javascript; charset=utf-8"
            } ], self);
            const t = new c.Blob(...c.uBOL_setConstant);
            m = c.URL.createObjectURL(t);
            const n = c.document;
            e = n.createElement("script"), e.async = !1, e.src = m, (n.head || n.documentElement || n).append(e);
        } catch (o) {}
        m && (e && e.remove(), c.URL.revokeObjectURL(m)), delete c.uBOL_setConstant;
    }
})();