...
(() => {
    const e = function() {
        const e = {}, t = [ [ 'function neTick(){neTickCounter++;if(neTickCounter<=neTickCountLimit){neTickAjax=$.ajax({type:"POST"', 'url:adminAjaxUrl+"?action=ne_tick"', 'dataType:"json"', "success:function(data){neTickResponseAction(data)}})}}", "10000" ], [ "muted", "8000" ], [ "seead" ] ], n = new Map([ [ "naekranie.pl", 0 ], [ "playpuls.pl", 1 ], [ "zspnr1.lowicz.pl", 2 ] ]), r = new Map([]), o = new Map([]);
        function s(t = "", n = "") {
            ...
            self.setInterval = new Proxy(self.setInterval, {
                apply: function(e, a, l) {
                    const p = l[0] instanceof Function ? String(r.Function_toString(l[0])) : String(l[0]), g = l[1];
                    if ("" === t && void 0 === n) return r.uboLog(o, `Called:\n${p}\n${g}`), Reflect.apply(e, a, l);
                    let f;
                    return "" !== t && (f = c.test(p) !== s), !1 !== f && void 0 !== n && (f = (g === n || isNaN(g) && isNaN(n)) !== i), 
