...
(() => {
    const e = function() {
        const e = {}, t = [ [ "nocontext" ], [ "vc_url" ], [ "show_wpcp_message" ], [ "tinPa" ], [ "SGPB_POPUP_PARAMS" ], [ "needpop" ], [ "banner" ], [ "window.LOCO_DATA.copyrightTranslation" ] ], r = new Map([ [ "coffeeapps.ir", 0 ], [ "sclinic.ir", 0 ], [ "nab-music.com", 1 ], [ "shahanmusic.ir", 2 ], [ "tinroid.ir", 3 ], [ "tak3da.com", 4 ], [ "yeknet.ir", 5 ], [ "zoomg.ir", 6 ], [ "oila.tj", 7 ] ]), o = new Map([]), n = new Map([]);
        function s(e = "") {
            if ("string" != typeof e) return;
            if ("" === e) return;
            const t = i(), r = t.makeLogPrefix("abort-on-property-read", e), o = function() {
                ...
                const o = t.slice(0, r);
                let i = e[o];
                if (t = t.slice(r + 1), i) return void s(i, t);
