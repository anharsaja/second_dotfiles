...
(() => {
    const e = function() {
        const e = {}, t = [ [] ], o = new Map([ [ "japaneseasmr.top", 0 ], [ "kokeshi-doll.com", 0 ], [ "uraaka-joshi.com", 0 ], [ "oppaideippai.net", 0 ], [ "trendynailwraps.com", 0 ], [ "wav.tv", 0 ], [ "asg.to", 0 ], [ "dl.520cc.cc", 0 ] ]), n = new Map([]), r = new Map([]);
        function s(t = "", o = "", n = "") {
            const r = function() {
            ...
            window.open = new Proxy(window.open, {
                apply: function(e, t, o) {
                    ...
                    let f = ("obj" === n ? l("object", "data", ...o) : l("iframe", "src", ...o)).contentWindow;
                    if ("object" == typeof f && null !== f) Object.defineProperty(f, "closed", {
                        value: !1
                    }); else {
                    ...
                    return 0 !== r.logLevel && (f = new Proxy(f, {
                        get: function(e, t) {
