...
!function() {
    const e = {}, t = [ [ "adtura", "1" ] ], o = new Map([]), r = new Map([ [ "pelisflix2", 0 ] ]), n = new Map([]);
    function s(t, o, r, ...n) {
        !function(t = "", o = "", r = "") {
            if ("" === t) return;
            const n = function() {
            ...
            }(), s = n.makeLogPrefix("set-cookie", t, o, r), c = [ "accept", "reject", "accepted", "rejected", "notaccepted", "allow", "deny", "allowed", "disallow", "enable", "disable", "enabled", "disabled", "ok", "on", "off", "true", "t", "false", "f", "yes", "y", "no", "n", "necessary", "required", "approved", "disapproved" ], a = o.toLowerCase(), l = /^("?)(.+)\1$/.exec(a), p = l && l[2] || a;
            if (!1 === c.includes(p)) {
                if (!1 === /^\d+$/.test(p)) return;
