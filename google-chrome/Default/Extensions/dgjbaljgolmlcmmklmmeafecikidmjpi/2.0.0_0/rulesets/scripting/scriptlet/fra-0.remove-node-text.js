...
!function() {
    const e = {}, t = [ [ "script", "https://www.aozoiekopoaka.shop/" ] ], o = new Map([ [ "japscan.lol", 0 ] ]), r = new Map([]), n = new Map([]);
    function s(e, t, ...o) {
        !function(e = "", t = "", o = "") {
            const r = i(), n = r.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = r.patternToRegex(e, "i", !0), c = r.patternToRegex(t, "gms"), a = r.getExtraArgs(Array.from(arguments), 3), l = r.patternToRegex(a.condition || "", "ms"), g = (e = !0) => {
                e && f(u.takeRecords()), u.disconnect(), r.logLevel > 1 && r.uboLog(n, "Quitting");
            };
            let d = a.sedCount || 0;
            const p = e => {
