...
!function() {
    const e = {}, t = [ [ "visited", "#oRslt li a.visited", "stay" ], [ "with-ad", "section.main" ], [ "has-topbanner", "body > header.has-topbanner" ] ], o = new Map([ [ "o-dan.net", 0 ], [ "video.laxd.com", 1 ], [ "phileweb.com", 2 ] ]), r = new Map([]), n = new Map([]);
    function s(e = "", t = "", o = "") {
        if ("string" != typeof e) return;
        if ("" === e) return;
        const r = i(), n = r.makeLogPrefix("remove-class", e, t, o), s = e.split(/\s*\|\s*/), a = s.map((e => `${t}.${CSS.escape(e)}`)).join(",");
