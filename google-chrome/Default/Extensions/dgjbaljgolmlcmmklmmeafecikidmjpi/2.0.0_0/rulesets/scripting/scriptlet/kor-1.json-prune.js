...
(() => {
    const e = function() {
        const e = {}, t = [ [ "tpl apply", "tpl.[].c" ], [ "data", "data.getBannerAdExchange" ], [ "powerLink", "powerLink.ads" ], [ "adRecommend.adUnits.[]" ], [ "data.BrandAd" ], [ "adBannerList" ], [ "data.supertopADNos" ], [ "ads" ] ], r = new Map([ [ "m.fmkorea.com", 0 ], [ "doctornow.co.kr", 1 ], [ "search.11st.co.kr", 2 ], [ "msearch.shopping.naver.com", 3 ], [ "search.shopping.naver.com", 4 ], [ "comic.naver.com", 5 ], [ "enuri.com", 6 ], [ "shoppinghow.kakao.com", 7 ] ]), n = new Map([]), o = new Map([]);
        function s(e = "", t = "", r = "") {
            const n = i(), o = n.makeLogPrefix("json-prune", e, t, r), s = n.initPattern(r, {
                canNegate: !0
            }), a = n.getExtraArgs(Array.from(arguments), 3);
            JSON.parse = new Proxy(JSON.parse, {
                apply: function(r, i, l) {
                    const f = Reflect.apply(r, i, l);
                    "" === e && n.uboLog(o, n.JSON_stringify(f, null, 2));
                    const p = c(f, e, t, s, a);
                    return void 0 === p ? f : (n.uboLog(o, "Pruned"), n.logLevel > 1 && n.uboLog(o, `After pruning:\n${n.JSON_stringify(p, null, 2)}`), 
                    p);
                }
            });
        }
        function c(e, t, r, n = {
            ...
            let f = "nomatch";
            if (c.mustProcess(e, l)) for (const t of s) a(e, t, !0) && (f = "match");
        ...
        function a(e, t, r = !1) {
            ...
            for (;;) {
                ...
                if ("[-]" === t && Array.isArray(n)) {
                    let e = n.length;
                    for (;e--; ) !1 !== a(n[e], s) && (n.splice(e, 1), c = !0);
                    return c;
                }
                if ("{-}" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== a(n[e], s) && (delete n[e], c = !0);
                    return c;
                }
                if ("[]" === t && Array.isArray(n) || "{}" === t && n instanceof Object || "*" === t && n instanceof Object) {
                    for (const e of Object.keys(n)) !1 !== a(n[e], s, r) && (c = !0);
                    return c;
                }
