...
!function() {
    const e = {}, t = [ [ "#progress-value", "data-timer", "10" ], [ ".owl-item > a > img", "src", "[data-src]" ], [ 'img[src="https://overclockers.ru/assets/logo_gray_stub.gif"]', "src", "[data-src]" ], [ "video", "controls", "true" ], [ 'video[controls="controls"]', "controls", "true" ] ], r = new Map([ [ "howdyho.net", 0 ], [ "eneyida.tv", 1 ], [ "overclockers.ru", 2 ], [ "dtf.ru", 3 ], [ "vc.ru", 3 ], [ "3dnews.kz", 4 ], [ "3dnews.ru", 4 ] ]), o = new Map([]), n = new Map([]);
    function s(e = "", t = "", r = "") {
        if ("" === e) return;
        if ("" === t) return;
        ...
        const c = e => "" !== s ? e.getAttribute(s) || "" : r, a = () => {
            const r = [];
            try {
            ...
            for (const e of r) {
                const r = e.getAttribute(t), s = c(e);
