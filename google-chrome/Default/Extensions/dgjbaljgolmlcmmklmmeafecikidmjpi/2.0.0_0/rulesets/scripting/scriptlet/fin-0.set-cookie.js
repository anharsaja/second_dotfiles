...
!function() {
    const e = {}, t = [ [ "cookielaw_accepted", "1", "", "reload", "1" ], [ "cookiebot-consent--necessary", "1" ], [ "cookiebot-consent--preferences", "1" ], [ "cookiebot-consent--marketing", "0" ], [ "cookiebot-consent--statistics", "0" ] ], o = new Map([ [ "srk.fi", 0 ], [ "aalto.fi", [ 1, 2, 3, 4 ] ] ]), r = new Map([]), n = new Map([]);
    function s(t = "", o = "", r = "") {
        if ("" === t) return;
        const n = function() {
