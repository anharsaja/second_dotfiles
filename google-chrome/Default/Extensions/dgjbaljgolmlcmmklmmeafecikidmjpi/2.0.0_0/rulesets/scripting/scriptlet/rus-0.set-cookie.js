...
!function() {
    const e = {}, t = [ [ "KUF_SUGGESTER_SHOW_2_ITERATION", "1" ], [ "cookieAccepted", "true" ], [ "cookie_accept", "1" ], [ "ha", "1" ], [ "kuf_agr", "true" ], [ "pg_SuggestGameFollow", "true" ], [ "telegram_popup", "Y" ] ], o = new Map([ [ "kufar.by", [ 0, 4 ] ], [ "liga.net", 1 ], [ "ixbt.com", 2 ], [ "forum.ixbt.com", 3 ], [ "playground.ru", 5 ], [ "kinotv.ru", 6 ] ]), r = new Map([]), n = new Map([]);
    function s(t = "", o = "", r = "") {
        if ("" === t) return;
        const n = function() {
