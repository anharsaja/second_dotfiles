...
(() => {
    const e = function() {
        const e = {}, t = [ [ "MediaFile", "", "fi-mtv3.videoplaza.tv/proxy/distributor" ] ], r = new Map([ [ "mtv.fi", 0 ], [ "mtvuutiset.fi", 0 ] ]), n = new Map([]), o = new Map([]);
        function s(t = "", r = "", n = "") {
            ...
            }(), s = o.makeLogPrefix("xml-prune", t, r, n), i = o.patternToRegex(n), c = o.getExtraArgs(Array.from(arguments), 3), a = e => {
                try {
